...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        # affine layer
        W2 = np.random.normal(0.0, weight_scale, (num_filters*HH*WW, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        # layer2 : affine
        X, cache_affine = affine_forward(X, W2, b2)
        X, cache_relu2  = relu_forward(X)

        # layer3 : affine
        X, cache_affine2 = affine_forward(X, W3, b3)
        ...
        dout, dW2, db2 = affine_backward(dout, cache_affine)
